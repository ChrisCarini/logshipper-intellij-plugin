...
public class SettingsManager implements ApplicationComponent, PersistentStateComponent<SettingsManager.Settings> {
    ...
    public static SettingsManager getInstance() {
        return ApplicationManager.getApplication().getComponent(SettingsManager.class);
    }
